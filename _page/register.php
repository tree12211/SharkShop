...
<div class="card border-0 shadow mb-4">
                        <div class="card-body">
                            <h5 class="m-0"><i class="fa fa-user-plus"></i> สมัครสมาชิก</h5>
                            <hr>
	<?php
	...
	<form name="register" method="POST">
		<div class="row">
			...
			<div class="col-md-6 mb-2">
				...
				<input name="con_password" class="form-control" type="password" placeholder="Confirm_Password"/>
			</div>
			<div class="col-md-12 mb-2">
				<label for="email">อีเมลล์</label>
				<input name="email" class="form-control" type="email" placeholder="Email Ex. admin@kpzoff.com"/>
			</div>
		</div>
		<hr/>
		<?php
